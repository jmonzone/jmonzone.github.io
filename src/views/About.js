...
export default function About() {
    ...
    const content = ["I am an XR developer based in New York City. I enjoy building video games, interactive web applications and immersive AR/VR experiences. My skillset primarily includes using tools such as Unity, Three.js, and React. I am currently employed full time for a media production agency in healthcare, where I lead development on our WebXR projects. I am also involved in WebGL projects as a freelance developer.", 
    ...
    return(
        <div className={`about`}>
            ...
            <div className="about-text">
                ...
                {content.map(text => <TextBlock key={text.slice(-5)} text={text}/>)}
            </div>
        </div>
    )
}